 ...
 */
#define PERIPHERAL_RESOURCE_SHARING_ENABLED  0 //Changed 6/28 @11:16 // 
...
#define CLOCK_CONFIG_LF_SRC             NRF_CLOCK_LFCLK_RC//NRF_CLOCK_LFCLK_Xtal
...
#define TWI0_CONFIG_SCL          0x01
#define TWI0_CONFIG_SDA          0x00
